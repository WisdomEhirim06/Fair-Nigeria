...
export const ERROR_CODES = {
  ...
  DUPLICATE_EMAIL: { http: 409, code: 'DUPLICATE_EMAIL' },
  ...
  PARTY_VOTES_MISMATCH: { http: 422, code: 'PARTY_VOTES_MISMATCH' },
  FIGURE_TALLY_MISMATCH: { http: 422, code: 'FIGURE_TALLY_MISMATCH' },
  SHEET_ALREADY_RESOLVED: { http: 409, code: 'SHEET_ALREADY_RESOLVED' },
  SELF_TRANSCRIPTION: { http: 422, code: 'SELF_TRANSCRIPTION' },
  NO_SHEETS_AVAILABLE: { http: 404, code: 'NO_SHEETS_AVAILABLE' },
